...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Már 08. 12:27
...
(1, 2, 6, 6, 2, '2022-09-22', 3, 'ETA Hoffmann - Az arany virágcserép'),
(2, 2, 6, 6, 5, '2022-09-27', 3, 'Csokonai-Berzsenyi'),
(3, 2, 6, 6, 1, '2022-10-29', 3, 'Victor Hugo- Nyomorultak'),
(4, 2, 6, 6, 5, '2022-11-14', 25, 'Fogalmazás'),
(5, 2, 4, 7, 3, '2022-10-10', 11, 'n-edik gyök'),
(6, 2, 4, 7, 4, '2022-10-28', 13, 'Exponenciális kifejezések, függvények'),
(7, 2, 4, 7, 4, '2022-11-10', 23, 'Logaritmusos kifejezések'),
(8, 2, 3, 2, 5, '2022-09-30', 23, 'Quick Test Unit 1'),
(9, 2, 3, 2, 5, '2022-10-28', 23, 'Quick Test Unit 2'),
(10, 2, 5, 3, 5, '2022-09-22', 2, 'Villamos feszültség, elektromos áramerősség'),
(11, 2, 5, 3, 5, '2022-11-14', 13, 'Órai munka ellenőrzése'),
(12, 2, 5, 3, 4, '2022-11-14', 13, 'Órai munka ellenőrzése'),
(13, 2, 1, 10, 5, '2022-09-30', 3, 'Az ipari forradalom, Kossuth és Széchenyi programj'),
(14, 2, 4, 7, 5, '2022-12-14', 24, 'Szinusz tétel'),
(15, 2, 1, 10, 3, '2022-10-27', 2, 'A márciusi forradalom az 1848-49-es szabadságharc'),
(16, 2, 1, 10, 3, '2022-11-28', 2, 'Az USA függetlenségi és polgárháborúja'),
(17, 2, 8, 8, 3, '2022-10-06', 3, 'IT (szódolgozat)'),
(18, 2, 8, 8, 5, '2022-11-09', 3, 'Vocabulary'),
(19, 2, 8, 8, 4, '2022-11-23', 3, 'Hardware'),
(20, 2, 2, 9, 5, '2022-09-26', 13, 'Helyből távolugrás'),
(21, 2, 2, 9, 5, '2022-10-06', 11, 'Na'),
(22, 2, 2, 9, 5, '2022-10-17', 11, 'megindulás, megállás'),
(23, 2, 2, 9, 5, '2022-10-28', 11, 'Na'),
(24, 2, 2, 9, 5, '2022-11-18', 11, 'Na'),
(25, 2, 9, 1, 5, '2022-10-12', 10, 'Nsql parancsoka'),
(26, 2, 9, 1, 4, '2022-10-26', 3, 'adat, korlátozások, mysql'),
(27, 2, 7, 5, 4, '2022-10-24', 10, 'Projekt1: Alapbeállítások megvalósítása'),
(28, 2, 7, 4, 4, '2022-09-20', 6, 'Alapvizsga ismétlés'),
(29, 2, 7, 4, 1, '2022-10-18', 23, 'OSI, TCP/IP, PDU, Network devices, Protocols'),
(30, 2, 7, 4, 1, '2022-10-18', 23, 'Alhálózat számítás'),
(31, 2, 7, 4, 5, '2022-10-25', 4, 'Kapcsolj!'),
(32, 2, 10, 11, 5, '2022-10-07', 6, 'Formázás'),
(33, 2, 10, 11, 5, '2022-10-14', 6, 'Műveletek'),
(34, 2, 10, 11, 5, '2022-10-28', 6, 'Busz (százalékszámítás)'),
...
(95, 14, 6, 6, 5, '2022-09-22', 3, 'ETA Hoffmann - Az arany virágcserép'),
(96, 14, 6, 6, 5, '2022-09-27', 3, 'Csokonai-Berzsenyi'),
(97, 14, 6, 6, 5, '2022-10-29', 3, 'Victor Hugo- Nyomorultak'),
(98, 14, 6, 6, 5, '2022-11-14', 25, 'Fogalmazás'),
(99, 14, 4, 7, 4, '2022-10-10', 11, 'n-edik gyök'),
(100, 14, 4, 7, 5, '2022-10-28', 13, 'Exponenciális kifejezések, függvények'),
(101, 14, 4, 7, 5, '2022-11-10', 3, 'Logaritmusos kifejezések'),
(102, 14, 3, 2, 5, '2022-09-30', 23, 'Quick Test Unit 1'),
(103, 14, 3, 2, 5, '2022-10-28', 23, 'Quick Test Unit 2'),
(104, 14, 5, 3, 5, '2022-09-15', 3, 'Villamos feszültség, elektromos áramerősség, Ohm t'),
(105, 14, 5, 3, 5, '2022-11-14', 13, 'Órai munka ellenőrzése'),
(106, 14, 5, 3, 4, '2022-11-14', 13, 'Órai munka ellenőrzése'),
(107, 14, 2, 9, 5, '2022-09-26', 13, 'Helyből távolugrás'),
(108, 14, 7, 4, 1, '2022-10-18', 3, 'OSI, TCP/IP, PDU, Network devices, Protocols'),
(109, 14, 7, 4, 2, '2022-10-28', 3, 'Alhálózat számítás'),
(110, 14, 7, 4, 4, '2022-10-25', 13, 'OSI, TCP/IP, PDU, Network devices, Protocols'),
(111, 14, 7, 4, 3, '2022-09-20', 3, 'Alapvizsga ismétlés'),
(112, 14, 10, 11, 5, '2022-12-16', 6, 'Vérnyomás'),
(113, 14, 10, 11, 5, '2022-11-18', 6, 'hózentróger'),
(114, 14, 9, 1, 5, '2022-12-14', 11, 'Select utasítás'),
(115, 14, 9, 1, 5, '2022-11-30', 3, 'delete, update, insert parancsok'),
(116, 14, 9, 1, 4, '2022-10-26', 11, 'adat, korlátozások, mysql'),
(117, 14, 9, 1, 5, '2022-10-12', 10, 'sql parancsok'),
(118, 14, 7, 5, 5, '2023-01-10', 11, '3. rétegbeli kapcsolás (VLAN)'),
(119, 14, 7, 5, 5, '2023-01-10', 10, 'projektmunka'),
(120, 14, 7, 4, 5, '2023-01-12', 6, 'Projekt II. -Packet, doksi'),
(121, 14, 1, 10, 5, '2023-01-17', 11, 'NaFüzetellenőrzés'),
(122, 14, 4, 7, 5, '2023-01-13', 24, 'Koszinusz tétel'),
(123, 14, 2, 9, 4, '2022-12-12', 6, 'Összefüggő talajgyakorlat'),
(124, 14, 2, 9, 5, '2022-10-17', 6, 'megindulás, megállás'),
(125, 14, 2, 9, 5, '2022-10-28', 11, 'Na'),
(126, 14, 2, 9, 4, '2022-11-07', 6, 'Fektetett dobás'),
(127, 14, 8, 8, 5, '2022-11-16', 3, 'Mediálás'),
(128, 14, 8, 8, 5, '2022-11-09', 3, 'Vocabulary'),
(129, 14, 8, 8, 5, '2022-10-19', 11, 'Szorgalom'),
(130, 14, 8, 8, 4, '2022-10-06', 3, 'IT (szódolgozat)'),
(131, 14, 1, 10, 5, '2022-09-30', 24, 'Az ipari forradalom'),
(132, 14, 1, 10, 4, '2022-11-11', 24, 'Az USA függetlenségi és polgárháborúja');
